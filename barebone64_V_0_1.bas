...
115 l0=49152:h0=49408: rem low stack and hi stack
120 ll=15: rem editor last line (0..ll)
130 ld=1000: rem last dictionary index (dic size-1)
140 bc=49664: rem begin of code area
...
4160 v$=w$:gosub 7600:v1=v:rem read dict
...
4250 print "unknown compiler instruction":stop
4260 return
...
6015 print "[";
6020 for i=0 to sp
6030   print peek(l0+i)+256*peek(h0+i);
6040 next i
6050 print "<- top ]"
6060 return
...
8210 if h$>="0" and h$<="9" then h=asc(h$)-asc("0")
8220 if h$>="a" and h$<="f" then h=asc(h$)-asc("a")+10
8230 return
